...
public class TelaTemas {
	...
	public TelaTemas() {
		...
		nomes.setIcon(new ImageIcon(TelaSubtemas.class.getResource("/imagem/Botao_r.png")));
		...
		geografia.setIcon(new ImageIcon(TelaSubtemas.class.getResource("/imagem/Botao_r.png")));
		...
		natureza.setIcon(new ImageIcon(TelaSubtemas.class.getResource("/imagem/Botao_r.png")));
		...
		esportes.setIcon(new ImageIcon(TelaSubtemas.class.getResource("/imagem/Botao_r.png")));
		...
		placa.setIcon(new ImageIcon(TelaSubtemas.class.getResource("/imagem/Placa.png")));
