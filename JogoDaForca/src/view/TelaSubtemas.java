...
public class TelaSubtemas {
	...
	public TelaSubtemas() {
		...
		botao1.setIcon(new ImageIcon(TelaSubtemas.class.getResource("/imagem/Botao_r.png")));
		...
		botao2.setIcon(new ImageIcon(TelaSubtemas.class.getResource("/imagem/Botao_r.png")));
