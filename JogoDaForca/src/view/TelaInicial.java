...
public class TelaInicial {
	...
	public TelaInicial() {
		...
		iniciar.setBackground(new Color(0,0,0,0));
		iniciar.setIcon(new ImageIcon(TelaSubtemas.class.getResource("/imagem/Botao_i.png")));
		...
		fechar.setIcon(new ImageIcon(TelaSubtemas.class.getResource("/imagem/Botao_i.png")));

		imagem.setBounds(450, 105, 299, 318);
		imagem.setIcon(new ImageIcon(Janela.class.getResource("/imagem/Forca.png")));
